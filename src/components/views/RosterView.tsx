...
const RosterView = () => {
    ...
    const [isAssignDogsModalOpen, setAssignDogsModalOpen] = useState(false);
    ...
    const toggleSelection = (id: string) => {
        // Allow selecting any user except yourself
    ...
    return (
        <div className="space-y-6 pb-32 lg:pb-8 min-h-[50vh] relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {filteredStaff.map(user => {
                            ...
                            return (
                                ...
                                >
                                    {/* Selection Checkbox - Allow selecting anyone except yourself */}
                                    ...
                                    <div className="flex justify-between items-center pt-3 border-t border-slate-50">
                                        ...
                                        <button
                                            onClick={(e) => {
                                                ...
                                                setAssignDogsModalOpen(true);
                                            }}
                                            className="text-xs font-bold text-slate-500 hover:text-indigo-600 px-3 py-1.5 hover:bg-slate-50 rounded-lg transition-colors flex items-center gap-1"
                                        >
                                            <Dog size={12} />
                                            Assign
                                        </button>
            ...
            <AssignDogsModal
                isOpen={isAssignDogsModalOpen}
                onClose={() => setAssignDogsModalOpen(false)}
                staffId={selectedStaffId}
            />
