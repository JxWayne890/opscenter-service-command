...
const TimesheetHeader: React.FC<TimesheetHeaderProps> = ({ shifts, dateRange, setDateRange }) => {
    // Calculate Stats
    const totalHours = shifts.reduce((acc, shift) => {
        if (!shift.end_time || shift.status === 'active') return acc;
    ...
    const handleExport = () => {
        const headers = ['Shift ID', 'User', 'Role', 'Start Time', 'End Time', 'Status'];
